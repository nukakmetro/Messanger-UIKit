//
//  СhatPreviewController.swift
//  TelegramUIKit
//
//  Created by surexnx on 10.11.2024.
//
...
final class ChatPreviewController: UIPreviewController {
    ...
    override func viewDidLoad() {
        ...
        previewSize = CGSize(width: view.frame.size.width, height: 400)
    ...
    func setupSubviews() {
        let upBar = UIView()
        upBar.backgroundColor = .white
        upBar.translatesAutoresizingMaskIntoConstraints = false
        preview.addSubview(upBar)
        preview.addSubview(collectionView)

        NSLayoutConstraint.activate([
            upBar.topAnchor.constraint(equalTo: preview.safeAreaLayoutGuide.topAnchor),
            upBar.leadingAnchor.constraint(equalTo: preview.safeAreaLayoutGuide.leadingAnchor),
            upBar.trailingAnchor.constraint(equalTo: preview.safeAreaLayoutGuide.trailingAnchor),
            upBar.heightAnchor.constraint(equalToConstant: 100)
        ])

        NSLayoutConstraint.activate([
            collectionView.topAnchor.constraint(equalTo: upBar.bottomAnchor),
            collectionView.bottomAnchor.constraint(equalTo: preview.safeAreaLayoutGuide.bottomAnchor, constant: 0),
            collectionView.leadingAnchor.constraint(equalTo: preview.safeAreaLayoutGuide.leadingAnchor),
            collectionView.trailingAnchor.constraint(equalTo: preview.safeAreaLayoutGuide.trailingAnchor),
        ])
        preview.layoutIfNeeded()
    }
}

extension ChatPreviewController: UIScrollViewDelegate {
...
extension ChatPreviewController: ChatControllerDelegate {
